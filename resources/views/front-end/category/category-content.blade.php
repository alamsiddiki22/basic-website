...
<div class="contentsection contemplete clear">
    <div class="maincontent clear">
        <div class="about clear">
            ...
            <img src="{{ asset('/') }}/front-end/images/3.jpg" alt="my image">
            <p>
                Our post is Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex ratione atque inventore voluptatum, eius neque quos vero cumque iure illum facilis, dicta nesciunt. Ducimus est nam veritatis, accusamus pariatur, voluptatibusLorem ipsum dolor sit amet, consectetur adipisicing elit. Ex ratione atque inventore voluptatum.
            </p>
            <div class="myicon">
                <a href=""><i class="fa fa-bicycle"></i></a>
            </div>
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/gDbw2mI2ftM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <p>
